...
describe "Users Descriptions Endpoint", type: :request do
  it "post /api/v1/users/:id/descriptions" do
    ...
    post "/api/v1/users/#{user2.id}/descriptions", params: json.to_json, headers: headers
    assignment.reload
  ...
  it "Posts /api/v1/users/:id/descriptions already_exists_sad_path" do
    ...
    post "/api/v1/users/#{user.id}/descriptions", params: json.to_json, headers: headers
    assignment.reload
  ...
  it "get /api/v1/users/:id/descriptions" do
    ...
    create(:assignment, assignee: user3, assigned: user1)
    create(:assignment, assignee: user2, assigned: user1)
    create(:adjective, name: "shy")
